...
export const LocationBrandBanner: React.FC<IBrandBannerProps> = (props) => {
        ...
        <>
            <SectionLayout noYPadding>
                <div className='w-full flex flex-col lg:flex-row py-10'>
                    <div className='w-full relative flex flex-col text-center md:text-start justify-between md:py-20'>
                        <div className='space-y-2 md:space-y-4 z-10'>
                            <h1 className="text-[3rem] leading-[3.5rem] text-[3.4rem] leading-[4rem] font-semibold text-primary">
                                {brandInfo?.data?.text} <span className='text-primaryDark'>Appliance Repair in</span> Houston, TX
                            </h1>
                    ...
                    <motion.div
                        ...
                        className='w-full flex items-center justify-center -mr-[50px]'
                    >
                        <Image
            ...
            <SectionLayout noYPadding>
                <p className='text-gray-500 text-md'>
                    ...
                    across Houston, TX. Whether it's a dishwasher, refrigerator, washing machine, or any other home appliance, our expert
