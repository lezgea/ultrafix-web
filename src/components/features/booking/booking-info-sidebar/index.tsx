...
export const BookingInfoSidebar: React.FC<IBookingInfoSidebar> = (props) => {
    ...
    return (
        <div>
            <div className='flex z-30 md:hidden fixed items-center h-screen'>
                ...
                <button
                    type="button"
                    className="inline-flex w-auto text-center text-lg items-center px-5 pt-2 pb-5 text-white transition-all bg-primaryMedium rounded-lg sm:w-auto hover:bg-primaryDark shadow-neutral-300 hover:shadow-lg hover:shadow-neutral-300 hover:-translate-y-px focus:shadow-none rotate-90"
