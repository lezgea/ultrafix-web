...
export const FindTechnician: React.FC<IFindTechnicianProps> = (props) => {
    ...
    return (
        <SectionLayout title="Find an UltraFix techinician in your area">
            {/* <Stepper /> */}
            <div className="flex w-full justify-center space-y-10">
                <form className="space-y-3 md:space-y-5 select-none min-w-[30%] max-w-[40%]" onSubmit={handleSubmit(onSubmit)}>
