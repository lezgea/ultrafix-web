...
export const DaySelect: React.FC<IDaySelectProps> = (props) => {
    ...
    return (
        <div
            onClick={onSelect}
            className={`rounded-full flex flex-col items-center justify-center min-w-[65px] max-w-[65px] min-h-[65px] max-h-[65px] text-md text-gray-400 font-medium cursor-pointer group ${selected ? 'bg-[#0551A8]' : 'border border-gray-200 hover:shadow-md'}`}
        >
